...
public class AdminController {
	...
	/* REMARKS:REMOVE EMPLOYEES FROM BATCHDTO */
	...
	/* CHECKED */
	/* HERE I HAVE REMOVED EMPLOYEE FROM MENTOR DTO */
	...
	/*
	 * TO USE THIS API, INITIALLY YOU HAVE SEND THE REQUEST TO ADMIN
	 * FROM EMPLOYEE CONTROLLER 
	 * ,THEN ONLY ACCEPT,REJECT APIs WILL WORK
	 */	
	...
	public ResponseEntity<SuccessResponse> deleteBatch(@RequestParam("id") String batchId) {
